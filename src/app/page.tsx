      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-white">
        <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16 ">
          <div className="w-screen">
            ...
            <div className="border-b bg-cyan-900 py-8 text-white">
              <div className="container mx-auto max-w-5xl">
                <h2 className="my-2 w-full text-center text-5xl font-bold leading-tight">
                  Title
                </h2>
                <div className="mb-4 w-full">
                  <div className="mx-auto my-0 h-1 w-64 rounded-t bg-white py-0 opacity-25"></div>
                </div>
                ...
                <div className="flex w-full flex-shrink flex-grow flex-col p-6 md:w-1/3">
                  ...
                  <div className="mt-auto flex-none overflow-hidden rounded-b rounded-t-none bg-white p-6 shadow">
                    <div className="flex items-center justify-start">
                      <button className="gradient focus:shadow-outline mx-auto my-6 transform rounded-full px-8 py-4 font-bold text-white shadow-lg transition duration-300 ease-in-out hover:scale-105 hover:underline focus:outline-none lg:mx-0">
                        Action
                      </button>
                    </div>
                  </div>
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="flex flex-col items-center justify-center gap-4">
              ...
              <Link
                ...
                className="rounded-full bg-cyan-600 px-10 py-3 font-semibold no-underline transition hover:bg-cyan-800"
              >
