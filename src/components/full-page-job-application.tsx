...
export default async function FullPageJobApplicationView(props: {
  ...
  return (
    <div className="container flex h-full w-full items-center justify-center bg-white p-24">
      ...
      <div className="mx-8 flex h-full w-56 flex-shrink-0 flex-col border-l border-black">
        <Link
          href={application.job_description_url ?? "#"}
          className={`ml-8 ${buttonVariants({ variant: "outline" })}`}
        >
